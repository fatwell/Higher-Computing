...
def size_of_dog():
    ...
    while SizeDog not in ["small", "medium", "large"]:
        print("Error that is not small medium or large")
        SizeDog = input("What size is your dog?(small, medium or large): ")
    return SizeDog
...
def ReccomendationMessage(SizeDog, totalWeight):
    ...
    elif SizeDog == "medium" and totalWeight >= 330 and totalWeight <= 440:
